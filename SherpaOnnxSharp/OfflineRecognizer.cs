...
#pragma warning restore CS8602 // 解引用可能出现空引用。
            ...
            _offlineRecognizer =
                DLL.SherpaOnnx.CreateOfflineRecognizer(sherpaOnnxOfflineRecognizerConfig);
        ...
        {
            SherpaOnnxOfflineStream stream = DLL.SherpaOnnx.CreateOfflineStream(_offlineRecognizer);
        ...
        {
            DLL.SherpaOnnx.AcceptWaveform(stream, sample_rate, samples, samples.Length);
        }
        ...
        public void DecodeMultipleOfflineStreams(OfflineStream[] streams)
        {
            ...
            DLL.SherpaOnnx.DecodeMultipleOfflineStreams(_offlineRecognizer, streamsIntPtr, streams.Length);
            Marshal.FreeHGlobal(streamsIntPtr);
        }

        internal OfflineRecognizerResultEntity GetResult(SherpaOnnxOfflineStream stream)
        {
            IntPtr result_ip = DLL.SherpaOnnx.GetOfflineStreamResult(stream);
