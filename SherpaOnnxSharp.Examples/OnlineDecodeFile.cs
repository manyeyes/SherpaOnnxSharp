...
/// NuGet for SherpaOnnxSharp
/// PM > Install-Package NAudio -version 2.1.0 -Project SherpaOnnxSharp.Examples
/// PM > Install-Package Microsoft.Extensions.Logging -version 7.0.0 -SherpaOnnxSharp

// transducer Usage:
/*
 .\SherpaOnnxSharp.Examples.exe `
...
namespace SherpaOnnxSharp.Examples
{
...
";
            ...
            if (!(string.IsNullOrEmpty(encoder) || string.IsNullOrEmpty(decoder) || string.IsNullOrEmpty(joiner)))
            {
                ...
                foreach (string wavFile in wavFiles)
                {
                    ...
                    List<float[]> samplesList = Utils.AudioHelper.GetChunkSamplesList(wavFile, ref duration);
